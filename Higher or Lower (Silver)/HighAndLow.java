...
public class HighAndLow {
    public void game() {
        ...
        Deck myDeck = new Deck("Deck"); //Make new deck
        myDeck.cardCreater();
        myDeck.shuffleCards();
        ...
        while (!valid) {
            Card firstCard = myDeck.drawCard();// get the first card from the Deck
            myDeck.removeCard();// without it is not gonna work due to first card will be stuck
            Card secondCard = myDeck.drawCard();// get the second card from the Deck
